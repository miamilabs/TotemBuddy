...
L["Right-Click Opens Selector"] = "Right-Click Opens Selector"
L["When Lock Selector is enabled, right-clicking still opens the selector menu"] = "When Lock Selector is enabled, right-clicking still opens the selector menu"
